...
import de.piapi.gpio.impl.SimpleSPIApi;
...
public class PlantAPI {
	...
	private SPIApi spiApi = new SimpleSPIApi();
	...
	public ResponseEntity<Integer> getHumidity(@PathVariable(value = "id") final int id) {
		...
		if (plant != null) {
			...
			response = new ResponseEntity<Integer>(HttpStatus.INTERNAL_SERVER_ERROR);
	...
	public @ResponseBody boolean addPlant(@RequestBody SimplePlant plant) {
	...
	private void initPlants() {
		...
		Plant plant0 = new SimplePlant(name, waterPumpAddr, spiChannel);
